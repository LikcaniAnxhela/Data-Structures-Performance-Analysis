...
public class ProjectPart2Test {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // Read 10,000 words from the file
            ...
            System.out.println("Insert Time : "
                    + (endBSTInsert - startBSTInsert) + " ns");

            System.out.println("Search Time : "
                    + (endBSTSearch - startBSTSearch) + " ns");

            System.out.println("Remove Time : "
                    + (endBSTRemove - startBSTRemove) + " ns");

            System.out.println();

            System.out.println("AVL TREE");
            System.out.println("Insert Time : "
                    + (endAVLInsert - startAVLInsert) + " ns");

            System.out.println("Search Time : "
                    + (endAVLSearch - startAVLSearch) + " ns");

            System.out.println("Remove Time : "
                    + (endAVLRemove - startAVLRemove) + " ns");

            System.out.println();

            System.out.println("HASH TABLE");
            System.out.println("Insert Time : "
                    + (endHashInsert - startHashInsert) + " ns");

            System.out.println("Search Time : "
                    + (endHashSearch - startHashSearch) + " ns");

            System.out.println("Remove Time : "
                    + (endHashRemove - startHashRemove) + " ns");
